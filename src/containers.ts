...
export function array<T>(element: Pipe<unknown, T>) {
	return {
		...
		decoder(input: Array<any>, ctx: Context): Result<Array<T>> {
...
export function object<T extends Record<string, Pipe<any, any>>>(shape: T) {
	return {
		...pipe<any, object>("any", "object"),
		isOutput: (v: any): v is object =>
			Object.prototype.toString.call(v) == "[object Object]",

		decoder(data: any, ctx: Context): Result<ShapeOutput<T>> {
...
export function record<K extends string | number, V>(
	...
	return {
		...pipe<any, Record<K, V>>("any", "recordKV"),
		isOutput: (v: any): v is object =>
			Object.prototype.toString.call(v) == "[object Object]",

		decoder(input: object, ctx: Context): Result<Record<K, V>> {
...
export function union<T extends Readonly<Array<Pipe<any, any>>>>(options: T) {
	...
	return {
		...pipe<any, O>("any", options.map((o) => o.outputType).join("|")),
		...
		decoder(data: O, ctx: Context): Result<O> {
